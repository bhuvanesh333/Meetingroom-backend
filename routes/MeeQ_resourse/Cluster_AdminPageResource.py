...
class ClusterAdminPageResourse:
    ...
    def cluster_add_conferenceroom(self,conferenceRoom_data:ConferenceRoom,
                                Cluster_ID: str = Header(..., alias="Cluster-ID")):
    ...
    def cluster_get_conferenceroom(self,Cluster_ID: str = Header(..., alias="Cluster-ID")):
    ...
    def cluster_delete_conferenceroom(self,Cluster_ID: str = Header(..., alias="Cluster-ID"),Room_ID: int = Header(..., alias="X-Room_ID")):
    ...
    def cluster_update_avail_conferenceroom(self,room_status:RoomStatusUpdate,Cluster_ID: str = Header(..., alias="Cluster-ID"),Room_ID: int = Header(..., alias="X-Room_ID")):
